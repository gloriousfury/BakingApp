...
public class RecipeAdapterTablet extends RecyclerView.Adapter<RecipeAdapterTablet.ViewHolder> {
    Context context;
    private List<Recipe> recipe_list;
    String RECIPE_ITEM_KEY = "recipe_item";


    public RecipeAdapterTablet(Context context,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recipe_list_item_tablet, parent, false);
